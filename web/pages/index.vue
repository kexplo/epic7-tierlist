<template>
  <tier-table v-model="search" :headers="headers" :items="tiers" title="Epic 7 Tier List (PvE)" />
</template>
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: 'PvE AVR', value: 'pve_average', class: 'pa-1', sortable: true, width: 50 },
        ...
        { text: 'Note', value: 'note', class: 'pa-1 cl-tier-note', width: 400 }
      ],
